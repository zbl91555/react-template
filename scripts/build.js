...
const sayings = [
  'JAVASCRIPT 很简单。但需要有一定天赋的人才能理解这种简单。',
  '程序中蕴含着很多的道理，唯有大彻大悟者方能体会其中的奥妙。',
  '世界上只有两句真理：1、人一定会死。2、程序一定有Bug。',
  '真正的程序猿不写文档也不需要文档，只有看不懂程序的笨蛋才用文档。',
  '编程之八字真言：八个字：1、专2、静3、谦4、筹5、悟6、慎7、透8、恒。',
  ...
  console.log(
    chalk.yellow(
      [
        ...
        '         佛祖保佑       永无BUG',
        '         佛曰：' +
          chalk.red.bold(sayings[Math.floor(Math.random() * sayings.length)])
      ].join('\n')
    )
  )
